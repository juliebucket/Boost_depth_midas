...
for img=1:numel(imglist)
    ...
    if dataset_disp_gttype
        ...
        figure;imshowpair(gt_depth,gt_disp,'montage')
    else
    ...
    %save_path2=fullfile(estimation_path,sprintf('%s_depth.png',imagename))
        

    %imwrite(estimate_depth,save_path2);
